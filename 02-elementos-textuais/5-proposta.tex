...
%		\includegraphics[width=0.6\textwidth]{./04-figuras/questionario/4.png}
...
\begin{figure}[H]
	...
	\center
	\subfigure[fig:motivosparacarona1][Parte 1]{\includegraphics[width=8.5cm]{./04-figuras/questionario/13.png}}
	\qquad
	\subfigure[fig:motivosparacarona2][Parte 2]{\includegraphics[width=8.5cm]{./04-figuras/questionario/14.png}}
...
\begin{figure}[H]
	...
	\includegraphics[scale=0.7]{./04-figuras/desenvolvimento/mudanças/notificacoes_firebase.png}
...
\begin{figure}[H]
	\center
	\subfigure[fig:dashboard][Atividade do usuário ao longo do tempo]{\includegraphics[width=0.4\textwidth]{./04-figuras/desenvolvimento/mudanças/dashboard-analytics.png}}
	\qquad
...
\begin{figure}[H]
	...
	\includegraphics[scale=0.2]{./04-figuras/desenvolvimento/mudanças/tela_facebook.jpeg}
	\label{fig:facebook}
	\fonte{Elaborado pelo autor.}
\end{figure}
...
\textbf{TERCEIRO TESTE: Criação de carona}
