...
\begin{figure}[h]
	...
	\center
	\subfigure[fig:motivosparacarona1][Parte 1]{\includegraphics[width=7.9cm]{./04-figuras/questionario/13.png}}
	\qquad
	\subfigure[fig:motivosparacarona2][Parte 2]{\includegraphics[width=7.9cm]{./04-figuras/questionario/14.png}}
