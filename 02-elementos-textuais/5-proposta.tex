...
%
	%\mnote{Patrícia: comentei toda a primeira parte. Toda justificativa e dados sobre macapá tem que vir lá na parte inicial, na introdução. Da uma revisão nisso. Dados sobre Macapá que estão aqui devem ir lá p cima.}
    % comnentado para não aparecer no compilado
\begin{comment}
Na atualidade, a cidade de Macapá configura-se com 503.327 habitantes, segundo dados do IBGE, 2019, cujos os saltos de 20 anos de desenvolvimento da cidade conferem cerca de 96\% da população urbana. Macapá tinha em 2006, cerca de 54 mil automóveis pelas vias da cidade, no último levantamento realizado pelo IBGE em relação a frota de veículos em 2018, esse número saltou para 152.475 mil automóveis, logo, um aumento de 181\% na cidade de Macapá. 

Comparando com os números de veículos de todo o estado, cerca de 195.039 veículos (IBGE, 2018), Macapá possui 78 \% da frota total. Com apenas 8,8 \% da área urbanizada, Macapá chega a ter 266 carros por km² utilizando os dados do último censo realizado pelo IBGE, 2010. Macapá oferece apenas os ônibus como transporte público coletivo, tendo 159 ativos e 17 reservas (Quintas, 2018, p. 4), para circular por seus 28 bairros registrados (G1, 2020).

Pensando nisso e levando em consideração os dados que apresentam a dificuldade de se locomover através do transporte público na capital Macapá que proponho um serviço de carona solidaria na Unifap - Campus Macapá utilizando o código aberto disponibilizado pelos alunos do projeto Caronaê da Universidade Federal do Rio de Janeiro.

\end{comment}

%\section{Motivação} %não precisa colocar motivação aqui. Só apresenta os resultados que foram obtidos com o que já foi feito, faz uma análise do que eles representam para o andamento do trabalho e quais foram as decisões tomadas para o trabalho a partir deles.

\begin{comment} %essa parte aqui é a mesma coisa que a parte inicial da seção. Não deve estar aqui. Analise onde colocar no início do documento. Aliás tem umas informações repetidas aqui.

Com o crescente aumento populacional nas cidades e com o surgimento de problemas elencados a isso, emergiu-se as cidades inteligentes em meio a estes problemas e cidades inteligentes como soluções para tal \cite{dameri}. Essa já é a  nossa realidade, sabendo que cerca de 60\% da população se encontra em Macapá — Capital do Amapá — e tendo aproximadamente 80\% da frota de veículos (IBGE, 2018) temos nitidamente uma lotação na cidade, principalmente nos centros urbanos.
\end{comment}
...
\textbf{NOTA - NÃO ESQUECER:} \textit{Não fazer nenhuma afirmação sem dados e provas.}
%comentado só para remover do texto compilado
\end{comment}
...
Em relação a esse uso de tecnologia, a comunidade acadêmica já está bem familiarizada com aplicativos relacionados à mobilidade, das 186 respostas ao questionário, apenas 15,1\% responderam não utilizar nenhum dos aplicativos listados, figura \ref{fig:conhecimento-sobre-apps}.
...
%\textbf{[NF003] O sistema deve estar sempre disponível aos seus usuários, independente de horário ou dia da semana.%Desempenho}%
