...
\begin{figure}[h]
	\center
	\subfigure[fig:dashboard][Atividade do usuário ao longo do tempo]{\includegraphics[width=6cm]{./04-figuras/desenvolvimento/mudanças/dashboard-analytics.png}}
	\qquad
...
Você também pode usar sua foto de perfil do Facebook no aplicativo. Durante a manutenção 
...
\begin{figure}[H]
	...
	\label{fig:facebook}
	\fonte{Elaborado pelo autor.}
\end{figure}do aplicativo, tivemos que atualizar as bibliotecas utilizadas para fazê-los funcionar com novas versões do Android.
